...
| Endpoint | Method | URL |
|----------|--------|-----|
| Top Stories | GET | `https://app-cutibsbmq5fl-api-wL1zlEdVM6DY.gateway.appmedo.com/v1/news/top` |
| All News | GET | `https://app-cutibsbmq5fl-api-W9z3M6eOKQVL.gateway.appmedo.com/v1/news/all` |
| Similar News | GET | `https://app-cutibsbmq5fl-api-m9xKXDbR1oka.gateway.appmedo.com/v1/news/similar/{uuid}` |
| News by UUID | GET | `https://app-cutibsbmq5fl-api-qYGWo8XA7M7Y.gateway.appmedo.com/v1/news/uuid/{uuid}` |
| Sources | GET | `https://app-cutibsbmq5fl-api-oLpZ7eD5jJ5a.gateway.appmedo.com/v1/news/sources` |

Base host: `app-cutibsbmq5fl-api-wL1zlEdVM6DY.gateway.appmedo.com`
