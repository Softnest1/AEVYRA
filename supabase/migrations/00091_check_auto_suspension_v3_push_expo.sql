...
-- v3 : remplacer CallMeBot par push Expo natif → send-push-on-event
-- Les admins reçoivent un push critique même si notif_enabled = false (bypass admin)
...
BEGIN
  ...
  IF v_count = 3 THEN
    ...
    -- Envoyer un push Expo à chaque admin (bypass notif_enabled via report-alert)
  ...
  -- ── Seuil 5 : alerte rouge push aux admins ────────────────────────────────
